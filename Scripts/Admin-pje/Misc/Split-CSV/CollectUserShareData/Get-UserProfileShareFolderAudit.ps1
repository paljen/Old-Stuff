Function Get-UserProfileShareFolderAudit
{
    ...
    Version         :   1.0.0 June 21th 2013        
                         - First release
                        1.0.1 July 5th 2013        
                         - Changed all bool params to be switch instead
                         - Fixed errors which occurred if users existed, extra information was selected to be displayed, but the information did not exist in AD
