...
Function Get-EcSCORunbookServer
{
    ...
    Try 
    {
        ...
        $webRequest = Invoke-WebRequest -Uri "$(Get-EcSCOWebURI)/RunbookServers" -Credential $cred
...
Function Get-EcSCORunbook
{
    ...
    $rb = Invoke-RestMethod -Uri "$(Get-EcSCOWebURI)/Runbooks" -Method Get -Credential $cred
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUGtGuhHJwPp42klU6lJWecrG8
# jCGgggyvMIIGEDCCBPigAwIBAgITMAAAACpnbAZ3NwLCSQAAAAAAKjANBgkqhkiG
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQUdRPNchlP2n1vExIg2ARENUS3X2kwDQYJKoZI
# hvcNAQEBBQAEggEAEV75LrXA8Dz9eizGPZsq/lMZ4AQyRZc1dUvxu1PpNhQjIMOv
# jsAj4IvMxMm9rwaXm4QVl8514bkthDvzso/XlbNzCH3varbYIs/lGVk0shfcSmgi
# zLnNQtRadpP88r6gXpKcfNQEjVAZS6jrmtNfZDbT5wd3Ba+ucvRgyRBjn1chLo6S
# xhYBWBuWt1LqC9lbEOxpo105ZKCabUNXwyDkYUV3BO1dLgRNtDmByBv73JMAgQX8
# 3y+ejeWmn015N3I8KQO0RoeA1nFF233VY1Fd5bVoAD2NDZaXh+5YesgsGQVAdPVi
# HLgVfPXrVOMYiOFAbbDGIskwnpPq7ybznZQ91Q==
