...
$var = Powershell{
    ...
    # ------------------------------------------------------------------------
    # NAME: MonitorServerImages-5.ps3
    ...
    # 12/11/2015 Version 3, function based changes
    # 13/11/2015 Version 4, function based changes
    ...
    function Test-BackupPath 
    {
        ...
        try
        {
            ## Test if the backup folder exist, if not create it
            if($(Test-Path -PathType Container $Backup) -eq $false)
            {
    ...
    function Main
    {
        ...
        try 
        { 
            ## Test if a Session with the same name is Available
