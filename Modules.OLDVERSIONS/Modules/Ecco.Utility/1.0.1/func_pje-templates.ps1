Function New-EccoPSWorkflow
{
    ...
    .NOTES
	    ...
	    Purpose/Change: Initial Workflow development
    #>
    ...
    else
    {
        if($ComputerName -ne "")
        {
            ...
            Add-Content $wfScript "`t# Generate Credentials with ECCO Encrypted Automation Account snippet and paste here`n"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUhZqb88VI4EfGhbF3iOaYAzBR
# XT6gggyvMIIGEDCCBPigAwIBAgITMAAAACpnbAZ3NwLCSQAAAAAAKjANBgkqhkiG
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQUXmSPtS9TJ6D7sDS235xPuLROwfAwDQYJKoZI
# hvcNAQEBBQAEggEANZEVt88tjQKRhWCxs2hWXweqYm9mswVnygdP8Ymn3l6lzLL1
# kOJah+2zBQwlFkB13IMjAirmtj+n00nf+6I2YeeN9S6wqXQFsnvKkHNmYfDFyFdj
# p9F/Nn2c5Oa5Kg/9gzWxvnY4/uQtixcEa0LoTH4nbZOFmF6ExqpZks9av4tKtCn9
# c4ao268GzlwxhiFswoz93QQPtp8X33Noaotz8h1Mna2O5KisVYOrI7Exe1UELqbd
# KrzvfiSEMCYpW6liAsCUgZHOeMexL+WgPzVH0GGrHUEPZLQHSJx/J+ZYglhUM8qL
# 4NyHT7BvRKG63AtKv/7L+kP1q7xu/AMuA7cPVQ==
