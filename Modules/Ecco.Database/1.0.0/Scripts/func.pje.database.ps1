...
function Get-EcDBDataset
{
    <#
    .SYNOPSIS
	    Get database recordset

    .PARAMETER ConnectionString
        In the format "server=localhost\SQLEXPRESS;database=inventory;trusted_connection=True"
    
    .PARAMETER Query
        SQL string query - "SELECT <..> FROM <..>"

    .PARAMETER isSQLServer
        Switch for SQL Server Mode, DEFAULT OleDB mode

    .EXAMPLE
        Get-EcDatabaseData -connectionString $connectionString -query $query -isSQLServer
    ...
    .NOTES
        ...
        Module Script:  func.pje.database
...
function Invoke-EcDBQuery 
{
    ...
    .PARAMETER Query
        SQL string query - "UPDATE <..> FROM <..>"

    .PARAMETER isSQLServer
        Switch for SQL Server Mode, DEFAULT OleDB mode

    .EXAMPLE
        Invoke-EcDatabaseQuery -connectionString $connectionString -query $query -isSQLServer
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUVS0+dbNiS4h4JdhaSp+es1Fw
# 79CgggyvMIIGEDCCBPigAwIBAgITMAAAACpnbAZ3NwLCSQAAAAAAKjANBgkqhkiG
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQU6mK7yMPvt3fURZo4BayosiZhB4YwDQYJKoZI
# hvcNAQEBBQAEggEAqlQKXmn4MP5JS7JjrNetjyKKvNuCmt5C+UmS7A7rHTjbvVYs
# Zby22kNnTAf1xHRexaRrWSnBID95YPCtVyPWsSc79mECvLa3FN7g0HMyj6gdB7Wx
# SYFhOfx8vnlRlLrt+ETQkRGwDY5qLZNcWJ/2OzhAfOLU2QQMXCcYRBmZmPM/s1hF
# MOybk8Rt8ztOJqyvP4YklWRQO0EKjNDNWgc03NuTKEa5nEETIlolBSwIPQawQNQ/
# DVJQ/qZEOlIxD3QKdcJ0Qvduw48L2GexuhHg3NXqstgpb2KLHFUNOyj0utrgOz3k
# hfTpw+mIHfLdFGLuAm9Nw/XDw8yDOwUdZVWrUQ==
