...
function Get-EccoDBDataset
{
    ...
    .INPUTS
        String ConnectionString, in the format "server=localhost\SQLEXPRESS;database=inventory;trusted_connection=True"
        String Query , "SELECT <..> FROM <..>"
        isSQLServer - Switch for SQL Server Mode, DEFAULT OleDB mode

    .OUTPUTS
        DataSet

    .EXAMPLE
        Get-EccoDatabaseData -connectionString $connectionString -query $query -isSQLServer
    #>
...
function Invoke-EccoDBQuery 
{
    ...
    .EXAMPLE
        Invoke-EccoDatabaseQuery -connectionString $connectionString -query $query -isSQLServer
    #>
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUMNblZtAxo6FX2j5rLW11PlNf
# UHGgggyvMIIGEDCCBPigAwIBAgITMAAAACpnbAZ3NwLCSQAAAAAAKjANBgkqhkiG
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQUZq9ntOEykj99zN6q/E6Vu/pqhT8wDQYJKoZI
# hvcNAQEBBQAEggEADpoo4lGgmAit+lzoL2nMmG3T6Cz3mFwq0CtiuIfL6xzqGFXr
# wO+N06nISdmBlaaohfIJ3ishM6g8vaswuZMLwNaOLxqoStbl+vE3hwlhL6egXUZN
# LByzH11yaZNuvJq6qkFMbJ1Lxv60UfkuyVqOupSa3A+AxMKZrWtyjOpJew/fTgMm
# PO5dy/xlp+JkU7Remv8B+rQ6vHErKc96Flvl0JUbUMwxOf1SpQ42YZGG0bAiamqH
# VQ2/hIj1zyHwGVG7aRE8T5HRCNKeLAov7tyT4oGpyXpJihlkEwMjY5UHumv4p1c8
# m23SKmgox4j8wwq4QmLXQdTgD47BlSUJYZgJKw==
