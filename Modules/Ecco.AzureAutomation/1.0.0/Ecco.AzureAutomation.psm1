...
Get-ChildItem ("$Global:ModuleRepository\Ecco.AzureAutomation\1.0.0\Scripts") -Recurse -Verbose:$false | Where-Object -Verbose:$false { $_.Name -like "Func.*" } | ForEach-Object {
    try{. $_.FullName}
    catch{Write-Host -ForegroundColor DarkCyan $_.Exception.Message}} -Verbose:$false

Export-ModuleMember -Function Connect-EcAzureAutomation -Alias * -Cmdlet * -Verbose:$false


# SIG # Begin signature block
# MIIPSAYJKoZIhvcNAQcCoIIPOTCCDzUCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUSTLB66NHCSg6SN/FyJty3kA6
# +FigggyvMIIGEDCCBPigAwIBAgITMAAAACpnbAZ3NwLCSQAAAAAAKjANBgkqhkiG
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQU6xAimeusneAeOwtvBFHnV8jAqmEwDQYJKoZI
# hvcNAQEBBQAEggEAuSPdvtaoTIn/x46OWXb/z8gVCvQK4TRoLOivSllPyOGC5hZP
# 7XRaTf1Y2nCbPzl3uiQDFmz4/M4dDXdVV8B1HgWU7meau49o9nYuDUvCaoDZro0W
# 2m3wss0ElLOe1ZEH7cBhLU7NBPyAbwnH2elhph4d84ElDQNihBqHKIiPKsfYld3j
# QODycx06ttJSEUdFlZ0KPnNFzy9OPHkoncCxYxH9JAXuGvcBKlqKuG+Qz7DUsqZD
# q/NFXxaMBRxmz9PQV04wQnwPrgDamU1aC05fk1Z2Q0ePOhvPf7EyBdAUK8AcMhp3
# mfK5L7xet0Pd/s83AUpIEl4AwP05/7LTgqd7vg==
